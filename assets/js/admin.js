...
function getBooks(){
    var theUrl="http://cs.ashesi.edu.gh/~csashesi/class2016/kenneth-mensah/pos/model/book.php?cmd=9";
...
function getBook(id){
    $("#main-div").hide();
    var theUrl = "http://cs.ashesi.edu.gh/~csashesi/class2016/kenneth-mensah/pos/model/book.php?cmd=6&id=" + id;
    var obj = sendRequest(theUrl);   //send request to the above url
    if (obj.result === 1) {          //check result
...
function getOnlyBookDetails(id){
    var theUrl = "http://cs.ashesi.edu.gh/~csashesi/class2016/kenneth-mensah/pos/model/book.php?cmd=4&id=" + id;
    var obj = sendRequest(theUrl);   //send request to the above url
    if (obj.result === 1) {          //check result
...
function sendPurchase(){
    ...
    var price = $("#cost").text();
    var theUrl = "http://cs.ashesi.edu.gh/~csashesi/class2016/kenneth-mensah/pos/model/book.php?cmd=3&user="+
...
function addReview(id){
    ...
    var theUrl="http://cs.ashesi.edu.gh/~csashesi/class2016/kenneth-mensah/pos/model/book.php?cmd=2" +
...
function searchBook(){
    ...
    var st = $("#search").val();
    if(st.length > 0) {
        var theUrl = "http://cs.ashesi.edu.gh/~csashesi/class2016/kenneth-mensah/pos/model/book.php?cmd=5&st=" + st;
        var obj = sendRequest(theUrl);   //send request to the above url
        if (obj.result === 1) {          //check result
            showBooks(obj);
        } else {
...
function addBook(){
    ...
    var price = $('#price').val();
    var isbn = $('#isbn').val();
    var theUrl="http://cs.ashesi.edu.gh/~csashesi/class2016/kenneth-mensah/pos/model/book.php?cmd=1&" +
...
function viewSales(){
    var theUrl="http://cs.ashesi.edu.gh/~csashesi/class2016/kenneth-mensah/pos/model/book.php?cmd=8&user="+localStorage.getItem("username");
    var obj=sendRequest(theUrl);   //send request to the above url
    if(obj.result===1){          //check result
        showLibrary(obj);
